...
def betfair_vincente_ENG():
    ...
    # NomiSquadre = ['Inter', 'Juventus', 'Lazio', 'Roma', 'Atalanta', 'Cagliari','Parma', 'Napoli', 'Bologna', 'Torino', 'Milan', 'Verona', 'Sassuolo', 'Udinese', 'Fiorentina', 'Lecce','Sampdoria', 'Brescia', 'Spal', 'Genoa']
    
    # for i in SquadraCasa:
    #     for x in NomiSquadre:
    #         if x in i:
    #             print(x.)
